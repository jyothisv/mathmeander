...
design direction discovered while scoping "low-effort intra-document citations." The authoring **UX** layer that sits on
top of these invariants — the `@` citation gesture, naming (designator / epithet /
definiendum), link-after-the-fact, and creating reference targets on the fly — is recorded in
[references-and-naming.md](references-and-naming.md).
